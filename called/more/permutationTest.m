...
function [p, observeddifference, effectsize, p2Adjust] = permutationTest(sample1, sample2, permutations, varargin)
...
for n = 1:permutations
    ...
    p2Adjust(n) = (length(find(abs(randomSample1) == abs(randomSample2)))+1)/(numel(randomSample1)+1);
end
